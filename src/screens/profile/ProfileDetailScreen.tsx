    ...
    return (
        <ScrollView className="flex-1 bg-background-50">
            ...
            <Box className="relative h-[450px]">
                ...
                /> */}
                <FastImage
                    source={{ uri: 'https://agrcdev.jeasuns.com/agrcdev/php/uploads/profiles/AG0126-94693_1769585743.jpg' }}
                    style={{ width: windowWidth, height: 450 }}
                    resizeMode="cover"
                />
                ...
                <VStack className="absolute top-4 right-4 items-center gap-3 z-20">
                    ...
                    >
                        {/* <Box className="bg-black/50 px-3 py-1.5 rounded-lg flex-row items-center gap-2">
                        ...
                        <MotiView
                            // This triggers whenever activeIndex changes
                            animate={{
                                scale: [1, 1.1, 1],
                            }}
                            transition={{
                        ...
                        <HStack className="items-end justify-between">
                            <VStack space="xs" className="flex-1">
                                ...
                                <HStack className="items-center gap-2">
                                    ...
                                    <Icon as={CheckCircleIcon} className="text-blue-400" size="sm" />
                                </HStack>

                                {/* Bio Details */}
                                <Text className="text-white text-[15px] font-medium opacity-95">
                                    5' 5"  •  Nadar  •  Not working
                                </Text>
                                <Text className="text-white text-[15px] font-medium opacity-95">
                                    Hosur, Tamil Nadu
                                </Text>
            ...
            <VStack className="p-4 bg-white mt-2 relative">
                <Heading size="md" className="mb-2">About Josephin J</Heading>
            ...
            <VStack className="p-4 bg-white mt-2">
                ...
                <HStack className="flex-wrap gap-3">
                    {hobbies.map((item) => (
                        <Box key={item} className="rounded-full overflow-hidden border border-outline-100 shadow-sm">
                            <LinearGradient
                    ...
                    <VStack space="xl">
                        ...
                        <HStack className="items-center gap-4">
                            ...
                            <VStack className="flex-1">
                                ...
                                <Text className="font-bold text-typography-900 text-base">Never Married</Text>
                            </VStack>
                        </HStack>
                        ...
                        <HStack className="items-center gap-4">
                            ...
                            <VStack className="flex-1">
                                ...
                                <Text className="font-bold text-typography-900 text-base">Hosur, Tamil Nadu, India</Text>
                            </VStack>
                        </HStack>
                    </VStack>
                    ...
                    <VStack space="xl">
                        ...
                        <HStack className="items-center gap-4">
                            ...
                            <VStack className="flex-1">
                                ...
                                <HStack className="items-center gap-2">
                                    <Text className="font-bold text-typography-900 text-base">+91 8754******</Text>
                        ...
                        <HStack className="items-center gap-4">
                            ...
                            <VStack className="flex-1">
                                ...
                                <HStack className="items-center gap-2">
                                    <Text className="font-bold text-typography-900 text-base">**********@gmail.com</Text>
                                    <Icon as={LockIcon} size="xs" className="text-red-400" />
                                </HStack>
                            </VStack>
                        </HStack>
            ...
            <Box className="mx-4 my-4 bg-white border border-outline-100 rounded-3xl shadow-sm overflow-hidden">
                ...
                <Box className="bg-orange-400 p-4 flex-row items-center justify-center gap-3">
                    ...
                    <Text className="text-white font-bold text-center">
                        Add your details to see Josephin J's family
                    </Text>
                </Box>
                ...
                <VStack className="p-5" space="md">
                    ...
                    <VStack space="xs">
                        ...
                        <DetailRow
                            ...
                            value="2 Sisters (1 Married)"
                        />
                    </VStack>

                    <Divider className="my-2" />

                    {/* Section Lock for Family Bio */}
            ...
            <Box className="mx-4 my-4 rounded-3xl overflow-hidden shadow-sm border border-orange-100 bg-white">
                ...
                >
                    ...
                    <VStack space="lg">
                        <DetailRowStyled icon={UsersIcon} label="Family Type" value="Middle Class / Nuclear" />
                        <DetailRowStyled icon={BriefcaseIcon} label="Father's Occupation" value="Retired" />
                        <DetailRowStyled icon={BriefcaseIcon} label="Mother's Occupation" value="Housewife" />
                        <DetailRowStyled icon={UsersIcon} label="No. of Siblings" value="2 Sisters (1 Married)" />
                    </VStack>
            ...
            <Box className="mx-4 my-4 bg-white border border-outline-100 rounded-3xl shadow-sm overflow-hidden">
                {/* Blue/Indigo Gradient Header (Matches Family Card Style) */}
                <Box className="bg-indigo-500 p-4 flex-row items-center justify-center gap-3">
                    <Icon as={GraduationCapIcon} color="white" size="lg" />
                    <Text className="text-white font-bold text-center">
                ...
                <VStack className="p-5" space="md">
                    <Heading size="sm" className="text-typography-800">Professional Background</Heading>
                    ...
                    {/* Section Lock for Salary (Matches Family Details Logic) */}
                    <VStack className="items-center py-2 mt-2 bg-indigo-50/30 rounded-2xl border border-dashed border-indigo-200">
                        <HStack className="items-center gap-2 mb-3">
                            <Icon as={LockIcon} size="xs" className="text-indigo-600" />
                        ...
                        <Button
                            variant="outline"
                            className="border-indigo-500 rounded-full px-8 h-10 active:bg-indigo-50"
                        >
                            <ButtonText className="text-indigo-600 font-bold text-sm">View Income</ButtonText>
                        </Button>
                    </VStack>
                </VStack>
            </Box>
            ...
            >
                ...
                <VStack className="p-6" space="xl">
                    ...
                    <VStack space="lg">
                        <ProfessionalRow icon={GraduationCapIcon} label="Education" value="B.Tech Information Technology" />
                        <ProfessionalRow icon={SchoolIcon} label="College" value="Anna University, Chennai" />

                        <Divider className="bg-indigo-100/50 my-1" />

                        <ProfessionalRow icon={BriefcaseIcon} label="Occupation" value="Software Engineer" />
                        <ProfessionalRow icon={BuildingIcon} label="Employed In" value="Private Sector" />
                    </VStack>
...
const DetailRowStyled = ({ icon, label, value }: any) => (
    <HStack className="items-center gap-4">
        <Box className="bg-white p-3 rounded-2xl shadow-sm border border-orange-50">
            <Icon as={icon} size="sm" className="text-orange-500" />
        </Box>
        <VStack className="flex-1">
